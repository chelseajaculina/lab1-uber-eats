        ...
        <div className="login-container">
            ...
            <form onSubmit={handleSubmit} className="login-form">
                ...
                <button className="google-button" type="button">
                    <img src={require('../../images/google-icon.png')} alt="Google Icon" /> Continue with Google
                </button>
                <button className="apple-button" type="button">
                    <img src={require('../../images/apple-icon.png')} alt="Apple Icon" /> Continue with Apple
                </button>
                <div className="divider">
                    <hr className="line" /> <span>or</span> <hr className="line" />
                </div>
                <button className="qr-code-button" type="button">
                    <img src={require('../../images/qr-icon.png')} alt="QR Icon" /> Log in with QR code
                </button>
