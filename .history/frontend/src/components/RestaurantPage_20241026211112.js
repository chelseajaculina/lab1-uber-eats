...
const RestaurantPage = () => {
    ...
    const [isFavorite, setIsFavorite] = useState(false); // Track if restaurant is a favorite
    ...
    useEffect(() => {
        const fetchRestaurantData = async () => {
            try {
                ...
                setIsFavorite(response.data.is_favorite); // Assume backend returns if the restaurant is a favorite
                setLoading(false);
            } catch (error) {
    ...
    const toggleFavorite = async () => {
        try {
            ...
            if (isFavorite) {
                ...
                await axios.delete(`http://localhost:8000/api/customers/favorites/remove/${restaurant.restaurant_name}/`, {
                ...
                setIsFavorite(true); // Update state to reflect addition
            }
        } catch (error) {
