...
class Favorite(models.Model):
    ...
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE, related_name='favorite_customers')

    class Meta:
        unique_together = ('user', 'restaurant')  # Ensure each restaurant can only be favorited once per user
