...
const NavBarHome = () => {
    ...
    const handleSliderChange = (event) => {
        ...
        setActiveOption(value === '0' ? 'delivery' : 'pickup');
    };
    ...
    return (
        <>
            ...
            <div className="navbar-left">
                    ...
                    <div className="delivery-pickup-slider">
                        <span className={`slider-label ${activeOption === 'delivery' ? 'active' : ''}`}>Delivery</span>
                        <input 
                            type="range" 
                            min="0" 
                            max="1" 
                            value={activeOption === 'delivery' ? '0' : '1'} 
                            onChange={handleSliderChange} 
                            className="slider"
                        />
                        <span className={`slider-label ${activeOption === 'pickup' ? 'active' : ''}`}>Pickup</span>
                    </div>  
