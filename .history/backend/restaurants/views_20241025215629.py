...
class RestaurantProfileView(APIView):
    ...
    def patch(self, request, *args, **kwargs):
        try:
            ...
            logger.error("Restaurant not found for the authenticated user.")
...
class UploadRestaurantProfilePictureView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            # Handle case where profile picture should be removed
            if request.data.get('profile_picture') in [None, '']:
                # Remove the profile picture and save changes
                if restaurant.profile_picture:
