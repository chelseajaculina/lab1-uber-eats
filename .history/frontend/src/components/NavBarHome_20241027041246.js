...
const NavBarHome = () => {
    ...
    const handleLogout = () => {
        // Clear localStorage and reset login state
        ...
        if (token) {
            ...
            const fetchUserData = async () => {
                try {
                    ...
                    handleLogout();  // Log out if there’s an error with the token
                }
            };
            fetchUserData();
        } else {
        ...
        <>
            ...
            {isMenuOpen && (
                <div className="side-menu">
                    ...
                    <img src="/images/uber-eats-logo.jpg" alt="Uber Eats" style={{ width: 'auto', maxWidth: '200px', height: '100px' }} />
