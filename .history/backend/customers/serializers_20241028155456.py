...
from restaurants.serializers import RestaurantSerializer  # Import RestaurantSerializer
...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    def get_favorites(self, obj):
        # Get all favorite restaurants for the customer
        favorite_restaurants = Favorite.objects.filter(customer=obj).select_related('restaurant')
        return RestaurantSerializer([fav.restaurant for fav in favorite_restaurants], many=True).data
...
class Favorite(models.Model):
    ...
    def __str__(self):
        return f"{self.customer.username} - {self.restaurant.restaurant_name}"
