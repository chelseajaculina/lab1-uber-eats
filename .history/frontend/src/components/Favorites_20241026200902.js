...
const Favorites = () => {
    ...
    const fetchFavorites = async (token) => {
        try {
            ...
            setFavorites(response.data.favorites);  // Update the state with favorite data
        } catch (error) {
    ...
    const addFavorite = async (restaurantId) => {
        ...
        try {
            ...
            fetchFavorites(token);  // Refresh favorites list
        } catch (error) {
    ...
    const removeFavorite = async (restaurantId) => {
        ...
        try {
            ...
            setFavorites(favorites.filter(fav => fav.id !== restaurantId));  // Update favorites after removal
        } catch (error) {
