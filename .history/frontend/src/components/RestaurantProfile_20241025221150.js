...
class RestaurantProfile extends Component {
    constructor(props) {
        ...
        this.state = {
            restaurant: {
                ...
                email: '',
                timings: '',
                restaurantProfilePicture: localStorage.getItem('restaurantProfilePicture') || ''
            },
    ...
    handleSubmit = async (e) => {
        ...
        // Append profile picture to formData if it has been selected
        if (this.state.selectedProfilePicture instanceof File) {
            formData.append('profile_picture', this.state.selectedProfilePicture);
        }
        ...
        try {
            ...
            this.setState(prevState => ({
                restaurant: {
                    ...
                    // profilePicture: response.data.profile_picture ? `${this.mediaBaseURL}${response.data.profile_picture}` : prevState.restaurant.profilePicture
                }
            }));
