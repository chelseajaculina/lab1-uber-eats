...
import CartIcon from '../components/CartIcon'; // Assuming you have a CartIcon component
const NavBarHome = () => {
    const cartItemCount = 0; // Initialize cartItemCount, replace with actual logic if needed
const NavBarHome = () => {
