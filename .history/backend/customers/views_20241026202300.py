...
class CustomerFavoritesView(generics.ListAPIView):
    permission_classes = [IsAuthenticated]

    def get(self, request):
        # Use the authenticated customer directly from request.user
    ...
    def post(self, request):
        # Get the authenticated customer directly
        customer = request.user
    ...
    def delete(self, request, restaurant_id):
        ...
        try:
            restaurant = Restaurant.objects.get(id=restaurant_id)
            customer.favorites.remove(restaurant)  # Remove the restaurant from favorites
