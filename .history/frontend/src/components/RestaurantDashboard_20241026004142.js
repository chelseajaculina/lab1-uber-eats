...
const RestaurantDashboard = () => {
  ...
  const [banner, setBanner] = useState('/backend/static/images/login.png'); // Replace with your banner image path
  ...
  return (
    <div className="home-container">
      ...
      <div className="banner-container">
        <img src={bbackend/static/images/login.png alt="Restaurant Banner" className="restaurant-banner" />
